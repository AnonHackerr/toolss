...
while loop:
    ...
    if what == "1":
        ...
        os.system("cd /data/data/com.termux/files/home && cd Nethunter-In-Termux")
        os.system("cd /data/data/com.termux/files/home && chmod +x kalinethunter")
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        ...
        os.system("cd /data/data/com.termux/files/home && pip3 install -r requirements.txt")
        os.system("cd /data/data/com.termux/files/home")
        print("====================================")
        ...
        break
         ...
         os.system("cd /data/data/com.termux/files/home && rm Toolss.py")
